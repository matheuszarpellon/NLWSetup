    ...
    <TouchableOpacity 
      className={clsx(
        "rounded-lg border-2 m-1", {
          ...
          ["bg-violet-900 border-violet-700"] : amountAccomplishedPercentage > 0 && amountAccomplishedPercentage < 25,
          ["bg-violet-800 border-violet-600"] : amountAccomplishedPercentage >= 25 && amountAccomplishedPercentage < 50,
          ["bg-violet-700 border-violet-500"] : amountAccomplishedPercentage >= 50 && amountAccomplishedPercentage < 75,
